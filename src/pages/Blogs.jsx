...
const Blogs = () => {
    ...
    return (
        <>
            <section className="dark:bg-gray-800 dark:text-gray-100 py-6">
                <div className="container max-w-6xl p-6 mx-auto space-y-6 sm:space-y-12">
                    <Link to={`/blog/${blogs[0].id}`}
                        target='_blank'
                        rel="noopener noreferrer" href="#" className="block max-w-sm gap-3 mx-auto sm:max-w-full group hover:no-underline focus:no-underline lg:grid lg:grid-cols-12 dark:bg-gray-900">
