        ...
        <div className='flex relative '>
            ...
            </Link >
            {
                ...
                deletable && <div
                    ...
                    className='absolute bg-primary p-3 rounded-full scale-105 -top-5 -right-5
                cursor-pointer hover:scale-105'><MdDeleteForever className='text-secondary group-hover:text-primary' /></div>
            }
        </div>
